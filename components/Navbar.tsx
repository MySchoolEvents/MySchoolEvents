    ...
    <Center h="100%">
      <Stack spacing={60} w="100%" mr="xs">
        ...
        <Link href={`/`}>
          <UnstyledButton >
            <Group position="center">
              ...
              <Text color={selectedTab == "home" ? "#228be6" : "gray"} weight={selectedTab == "home" ? "bold" : "normal"}  >Home</Text>
            </Group>
          </UnstyledButton>
        </Link>
        ...
        <Link href={`/courses`}>
          <UnstyledButton>
            <Group position="center">
              <IconBooks color={selectedTab == "courses" ? "#228be6" : "gray"} fontWeight={selectedTab == "courses" ? "bold" : "regular"} />
              <Text color={selectedTab == "courses" ? "#228be6" : "gray"} weight={selectedTab == "courses" ? "bold" : "normal"}  >Courses</Text>
            </Group>
          </UnstyledButton>
        </Link>
        ...
        <Link href={`/settings`}>
          <UnstyledButton>
            <Group position='center'>
              ...
              <Text color={selectedTab == "settings" ? "#228be6" : "gray"} weight={selectedTab == "settings" ? "bold" : "normal"}  >Settings</Text>
            </Group>
          </UnstyledButton>
        </Link>
