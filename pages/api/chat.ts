...
export default async function handler(
	...
	const api = new ChatGPTAPI({
		...
		events using their student ID (it has a barcode on it that the application will scan) and a code given after 
		scanning their ID's barcode. Clicking the courses tab will redirect you to a courses page that lists the student's 
		courses. By clicking on each card, they can edit the course information (course title, teacher and icon) and 
		save it by clicking on the "Save button". By clicking on the plus icon, they can add new courses (This will open up a form where you can enter the course information 
		such as the course title, teacher and course display icon. After filling out the form, click on the "Create Course" button 
